...
/**
 * Inline SVG icons (lucide-style, 24×24, currentColor stroke). Kept local so
 * the demo pulls zero extra dependencies. All decorative unless a title is set.
 */
...
export const MessageCircle = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M21 11.5a8.4 8.4 0 0 1-9 8.4 8.7 8.7 0 0 1-3.9-.9L3 20l1-4a8.4 8.4 0 0 1-.9-3.9A8.4 8.4 0 0 1 11.5 3h.5a8.4 8.4 0 0 1 9 8z" />
  </svg>
);
