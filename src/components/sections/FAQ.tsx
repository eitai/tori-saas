...
const FAQS = [
  ...
  {
    q: "אפשר לנסות את המערכת?",
    a: "כן, יש דמו אינטראקטיבי. לוחצים על ״נסו את המערכת״ ונכנסים ללוח ניהול לדוגמה של מספרה: קובעים תור ביומן, מסמנים הגעה, מנהלים לקוחות ותזכורות, ורואים דוחות שמתעדכנים בזמן אמת. כל הנתונים הם להדגמה בלבד.",
  },
  {
